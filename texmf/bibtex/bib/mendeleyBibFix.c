 ...
 * DQ pulled this from Adam Noel's Github at 
 * https://github.com/adamjgnoel/mendeleyBibFix/blob/master/mendeleyBibFix.c
 ...
 * [DQ] The suggested call is gcc -std=c99 -Wall mendeleyBibFix.c -o mendeleyBibFix
 * Call syntax (Windows):
